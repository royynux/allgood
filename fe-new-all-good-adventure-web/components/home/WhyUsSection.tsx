...
const galleryImages = [
  { src: 'https://images.unsplash.com/photo-1501854140801-50d01698950b?w=400&q=80', alt: 'Rinjani', tall: false },
  { src: 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?w=400&q=80', alt: 'Gili', tall: true },
  { src: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&q=80', alt: 'Pantai', tall: false },
  { src: 'https://images.unsplash.com/photo-1494500764479-0c8f2919a3d8?w=400&q=80', alt: 'Lombok', tall: false },
]
        ...
        <div style={{
          ...
          <div>
            <div style={{ borderRadius: 'var(--r-lg)', overflow: 'hidden', position: 'relative', height: 195 }}>
              <Image src={galleryImages[0].src} alt={galleryImages[0].alt} fill style={{ objectFit: 'cover' }} />
            </div>
          </div>
          <div>
            <div style={{ borderRadius: 'var(--r-lg)', overflow: 'hidden', marginTop: 38, position: 'relative', height: 248 }}>
              <Image src={galleryImages[1].src} alt={galleryImages[1].alt} fill style={{ objectFit: 'cover' }} />
            </div>
          </div>
          <div>
            <div style={{ borderRadius: 'var(--r-lg)', overflow: 'hidden', position: 'relative', height: 195 }}>
              <Image src={galleryImages[2].src} alt={galleryImages[2].alt} fill style={{ objectFit: 'cover' }} />
            </div>
          </div>
          <div>
            <div style={{ borderRadius: 'var(--r-lg)', overflow: 'hidden', position: 'relative', height: 195 }}>
              <Image src={galleryImages[3].src} alt={galleryImages[3].alt} fill style={{ objectFit: 'cover' }} />
            </div>
          </div>
        </div>
      </div>
